...
from AuthorityManage.utils.request_util import get_request_user, get_request_ip, get_request_data, get_request_path, get_os, \
...
class ApiLoggingMiddleware(MiddlewareMixin):
    ...
    def __handle_response(self, request, response):
        ...
        info = {
            ...
            'json_result': {"code": response.data.get('code'), "message": response.data.get('message')},
        }
        operation_log = OperationLog.objects.create(**info)
